...
def test_run_preflight_downloads_and_validates_both_models(tmp_path, monkeypatch):
    from citypods.diarize import DEFAULT_DIARIZE_MODEL
...
def test_run_preflight_explains_a_download_failure(tmp_path, monkeypatch):
    from citypods.diarize import DEFAULT_DIARIZE_MODEL
