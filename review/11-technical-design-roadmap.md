...
| Topic tags / Strong Towns lens | #4 | **Implemented locally; shadow-dispatch rollout** (2026-07-16; no PR yet) | [`review/14`](14-topic-tags-strong-towns-lens.md) · 37-source-backed flat tags; deterministic episode/chapter annotations with taxonomy-ordered episode projection; explicit R3 chapter mappings only, transcript timing otherwise; chapter-aware R4/R1 payloads; Instructor/Pydantic additive suggestions through dispatch; candidates retain bounded transcript/document evidence; generic sparse calibration matrix and weekly review automatically control visibility, starting with a 100% feature/provider-model fallback; future crowd-sourced edits remain moderated proposals |
