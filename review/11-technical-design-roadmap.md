...
**Status: LIVING · last updated 2026-07-12 (catalog lifecycle sync: H14d, H16, H18, H19, H21, and
storage reclaim flipped to Shipped — their GitHub issues had closed and PRs merged without the
catalog-flip step in the doc-update contract keeping pace; see CHANGELOG.md for the corresponding
entries)**
