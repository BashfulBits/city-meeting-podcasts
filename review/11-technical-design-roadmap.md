...
| **Provider catalog reconciliation** | new | **Slice 1 shipped (observe and propose); Slices 2–4 L3** | [`review/48`](48-provider-catalog-reconciliation.md) · weekly catalog/health/candidate probes under the v2 dispatch pause (#1848), providers as plugins, one rolling decision issue. Next: Slice 2 `/apply` → curated additions PR; Slice 3 automatic removals + lane repair + `route_retired` job rescue; Slice 4 bounded limit maintenance |
