...
**Status: LIVING · last updated 2026-09-08 (review/45 reconciled against `main` after 123 commits and extended with Initiative 20 — LLM endpoint rate-limit characterization & failure-class-aware backoff, see review/45 §1.1 and §Initiative 20; interactive direct remedy #1231; Gemini free-tier hard input ceiling + `/remedy` deferral fix, §Rate-limited LLM dispatch Worker)**
