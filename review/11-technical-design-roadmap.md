...
|---|---|---|---|
| Per-meeting permalink pages | #46/GH#157 | **Shipped** (#897, 2026-07-13) | [`review/13`](13-per-meeting-pages-and-search.md) Part A · implementation `1790c9f` plus review fixes `20cc5ed` |
| **Rate-limited LLM dispatch Worker** (new, Infra) | new | **Shipped** (#899, 2026-07-13; pacing hardening followed) · **ROADMAP R10** | [`review/27`](27-llm-backend-and-provider-routing.md) §Worker · async enqueue/poll transport for R2's `JobHandle` path with queue persistence and reconciliation-safe polling |
...
| **LLM backend** (new, Infra) | new | **Shipped** (#919, 2026-07-13) · **ROADMAP R2** | [`review/27`](27-llm-backend-and-provider-routing.md) · LiteLLM adapter, normalized `JobResult`/`JobHandle` routing, Mistral dispatch integration, and reconciliation hardening are implemented; R5/R6 remain its feature consumers |
...
| **Agenda, packet, minutes text, votes, and roster extraction** (new, Infra) | new | **Shipped** (#920, 2026-07-14; hardening included in the same merged series) · **ROADMAP R3** | [`review/29`](29-agenda-text-extraction.md) · [`review/30`](30-minutes-text-votes-rosters.md) · agenda/portal, bounded backup/packet, minutes, vote, and roster artifacts are implemented; no OCR or LLM synthesis in the first pass |
| Static transcript search | #6 | **Shipped** (2026-07-14; `2f76744` + `60998a0`) | [`review/13`](13-per-meeting-pages-and-search.md) Part B · MiniSearch-based client-side search includes unavailable-record metadata and availability filtering |
| Topic tags / Strong Towns lens | #4 | **L3 — not started** (2026-07-14; implementation issue still to cut) | [`review/14`](14-topic-tags-strong-towns-lens.md) |
