...
and reports fixed, still-mismatched, missing-after, worsened, audio-key-changed, and
timeline-digest-changed counts for the PR6 gate. The artifact also carries planner-input telemetry
