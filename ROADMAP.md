...
| **R7** | **Implementation in progress (unmerged)** — calibrated native speaker diarization, voice profiles, minutes-backed roster correction, R6 pull-quote attribution, and static speaker pages; the revised design and exact public-identity gate are recorded in [`review/31`](review/31-speaker-diarization-attendee-extraction.md). This remains a 1.0 gate. |
