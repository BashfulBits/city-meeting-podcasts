...
| **R12** | **Not started** — **LLM-assisted city/agenda-source discovery**, L3 design in [`review/28`](review/28-llm-assisted-city-discovery.md); quarterly existing-city discovery and `add-city` bootstrapping remain to implement |
