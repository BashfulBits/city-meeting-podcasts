...
revisions pinned (#498), Renovate two-lane update flow + CI guards — plus the first **H14b Modal worker**
(#807) installing that same pinned stack and baked model. **H15 transcript-quality is now fully
shipped too:** L1 evidence capture, L2 independent forced alignment, L3 human-gold calibration/trend
reporting, and the `/admin/status` trust panel.
