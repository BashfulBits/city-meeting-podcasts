...
`citypods/compute/llm_routes.json`). The generated catalog contains 72 physical provider/account
routes representing 37 deduplicated logical models; every route supports direct LiteLLM and
...
| **`mistral/mistral-medium-3-5`** | ⭐ **Tier 2 (Enterprise Workhorse)**<br>Large Dense | Mistral AI + Airforce | 256k tokens (Airforce output capped at 4k) | Mistral: 22 RPM / 356.25k TPM<br>Airforce: 0.69 RPM / 1,000 RPD | Available in pool | Production agenda extraction, civic topic indexing, structured meeting summaries |
| **`mistral/mistral-medium-2508`** | ⭐ **Tier 2 (Enterprise Workhorse)**<br>Large Dense | Mistral AI | 128k tokens | 22 RPM<br>356.25k TPM | Available in pool | Production agenda extraction, civic topic indexing, structured meeting summaries |
