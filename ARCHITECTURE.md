...
- **Resource admission for expensive native work** — ffmpeg/ASR starts can wait for memory/load
  ...
  queue; the timed-out episode records durable timeout backoff instead of becoming a terminal
  failure. Audio encodes are admitted by a
