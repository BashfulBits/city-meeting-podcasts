...
- **Observable exhausted storage reads** — S3-compatible object reads raise a typed
  ...
  still propagate authentication, configuration, and other non-transient errors.
