...
def main(argv: list[str] | None = None) -> int:
    ...
    e.add_argument(
        "--lane",
        choices=["audio", "transcribe", "align", "tag", "chapter-agenda"],
        ...
        "'chapter-agenda' extracts agenda candidates. Default runs the full enrich "
        "(audio + transcript). The sharded workflows pin one lane "
