...
# deliberately kept out of the faster-whisper/WhisperX/torch stack asr.txt resolves.
...
# lock file: torch/torchaudio are already a transitive pin via WhisperX's own torch
